...
for targ in targ_list:
    ...
    # save dict
    joblib.dump(rf2_dict, randfor2_dir + targ + 'rf2-2_output_std.joblib', compress=0)
    joblib.dump(rf2_model, randfor2_dir + targ + 'rf2-2_model_std.joblib', compress=0) 
    # Save rf2_dict using pickle
    with open(randfor2_dir + targ + 'rf2-2_output_std.pkl', 'wb') as f:
        pickle.dump(rf2_dict, f)
    with open(randfor2_dir + targ + 'rf2-2_model_std.pkl', 'wb') as f:
