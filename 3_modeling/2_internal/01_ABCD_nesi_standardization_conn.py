...
# %%
def run_std(tr_index, te_index, path_out):
    try:
        ...
        def r_to_z(correlation_coefficient):
            return np.arctanh(correlation_coefficient)
        ...
        for key, feature in features.items():
            try:
                ...
                if 'rest' in key:
                    x_tr = x_tr.applymap(r_to_z)
                    x_te = x_te.applymap(r_to_z)
...
run_std(train_index, test_index, main_fold)
