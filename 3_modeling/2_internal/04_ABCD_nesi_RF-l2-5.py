...
moda_stack_dict = dict(
                        ...
                        str_abcd = ['Avg_T1_ASEG_Vol_', 'Dest_Area_', 'Dest_Thick_', 'Avg_T2_ASEG_', 'Vol_ASEG_', 'Dest_Vol_', 'T1_white', 'T1_gray', 'T2_white', 'T2_gray', 'Sulcal_Depth', 'T1_norm', 'T2_norm', 'T1_summ','T2_summ']
...
for targ in targ_list:
    ...
    All_enet1 = {**smri, **abcd_rsmri} # , **tang, **conn2
    ...
    # save dict
    joblib.dump(rf2_dict, randfor2_dir + targ + 'rf2-5_output_std.joblib', compress=0)
    joblib.dump(rf2_model, randfor2_dir + targ + 'rf2-5_model_std.joblib', compress=0) 
    # Save rf2_dict using pickle
    with open(randfor2_dir + targ + 'rf2-5_output_std.pkl', 'wb') as f:
        pickle.dump(rf2_dict, f)
    with open(randfor2_dir + targ + 'rf2-5_model_std.pkl', 'wb') as f:
