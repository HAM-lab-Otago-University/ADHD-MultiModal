...
for targ in targ_list:
    ...
    All_enet1 = {**cntr, **conn, **abcd_cntr, **mnct} # , **tang, **conn2
    ...
    # save dict
    joblib.dump(rf2_dict, randfor2_dir + targ + 'rf2-8_output_std.joblib', compress=0)
    joblib.dump(rf2_model, randfor2_dir + targ + 'rf2-8_model_std.joblib', compress=0) 
    # Save rf2_dict using pickle
    with open(randfor2_dir + targ + 'rf2-8_output_std.pkl', 'wb') as f:
        pickle.dump(rf2_dict, f)
    with open(randfor2_dir + targ + 'rf2-8_model_std.pkl', 'wb') as f:
