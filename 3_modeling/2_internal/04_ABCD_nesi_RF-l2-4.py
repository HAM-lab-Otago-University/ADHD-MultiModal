...
abcd_rsmri = ['Avg_T1_ASEG_Vol_', 'Dest_Area_', 'Dest_Thick_', 'Avg_T2_ASEG_', 'Vol_ASEG_', 'rsmri_within_avg_data', 'Dest_Vol_', 'rsmri_gordon_aseg_data']
# %%
moda_stack_dict = dict(

                        All1_abcd = ['DTI', 'cort', 'surf', 'subc', 'VolBrain', 'T1_white', 'T1_gray', 'T2_white', 'T2_gray', 'Sulcal_Depth', 'T1_norm', 'T2_norm', 'T1_summ','T2_summ','conn_rest', 
                                'conn_wm', 'conn_sst', 'conn_mid', 'subnet_rest', 'gfc', 'tfc'] 
                                 + contrasts_mid + contrasts_sst + contrasts_wm  + abcd_contrasts + abcd_rsmri, 
                                 
                        All2_abcd = ['DTI', 'cort', 'surf', 'subc', 'VolBrain', 'T1_white', 'T1_gray', 'T2_white', 'T2_gray', 'Sulcal_Depth', 'T1_norm', 'T2_norm', 'T1_summ','T2_summ','conn_rest', 
                                'conn_wm', 'conn_sst', 'conn_mid', 'subnet_rest', 'gfc', 'tfc'] + abcd_contrasts + abcd_rsmri,
...
for targ in targ_list:
    ...
    abcd_rsmri = joblib.load(enet1_dir + targ + 'abcd_rsmr_enet1_output_std.joblib') 
    abcd_cntr = joblib.load(enet1_dir + targ + 'abcd_cntr_enet1_output_std.joblib')  
   
    # conn2 = joblib.load(enet1_dir + targ + 'con2_enet1_output.joblib')
    # tang = joblib.load(enet1_dir + targ + 'tang_enet1_output.joblib')
    All_enet1 = {**smri, **cntr, **conn, **gtfc, **abcd_rsmri, **abcd_cntr} # , **tang, **conn2
    ...
    # save dict
    joblib.dump(rf2_dict, randfor2_dir + targ + 'rf2-4_output_std.joblib', compress=0)
    joblib.dump(rf2_model, randfor2_dir + targ + 'rf2-4_model_std.joblib', compress=0) 
    # Save rf2_dict using pickle
    with open(randfor2_dir + targ + 'rf2-4_output_std.pkl', 'wb') as f:
        pickle.dump(rf2_dict, f)
    with open(randfor2_dir + targ + 'rf2-4_model_std.pkl', 'wb') as f:
